...
const SearchItem: React.FC<SearchItemProps> = ({ title, author }) => {
  return (
    <div className="flex items-center gap-x-5">
      ...
      <div className="flex-1 text-sm">
        <h3 className="mb-1">
          <strong>{title}</strong> fund for {author}
        </h3>
        <p className="text-text3">By {author}</p>
      </div>
    </div>
  );
};
        ...
        <div className="search-results w-full lg:w-[843px] absolute top-full left-0 bg-white z-50 translate-y-5 pb-6 rounded-3xl">
          ...
          <div className="p-6 pb-0">
            <div className="flex flex-col mb-6 gap-y-5">
              <SearchItem title="Education" author="Durgham Family" />
              <SearchItem title="Education" author="Durgham Family" />
              <SearchItem title="Education" author="Durgham Family" />
              <SearchItem title="Education" author="Durgham Family" />
            </div>
