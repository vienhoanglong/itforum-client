                    ...
                    <div className="flex items-center">
                        ...
                        >
                            <img
                                src={logo}
                                alt=""
                                className="relative w-full lazy lazyloaded rounded-[9px]"
                            />
                        </a>
                    ...
                    <div className="flex flex-col justify-between h-full">
                        <div className="-mt-1 md:flex md:items-start">
                            <h4 className="mb-4 tracking-normal lg:clamp one-line md:pr-6 lg:mb-0">
                                ...
                                >
                                    Download PDF with image using DomPDF on
                                    Laravel 8
                                </a>
                            </h4>
                            <div className="relative hidden text-center md:ml-auto md:flex md:flex-row-reverse md:items-center">
                                <Link
                                    className="block px-0 py-2 ml-5 text-sm font-medium text-center btn-chanel w-28 text-text1"
                                    to={""}
                                >
                                    Code Review
                                </Link>
                        ...
                        <div className="lg:clamp two-lines mb-6 break-words leading-normal text-black/90 lg:mb-0 lg:pr-8 text-[1rem]">
                            I'm trying to download my data in my database with
                            images and tried some tutorials I found on internet
                            but I can't get to download those images together
                            with the data. I used dd(); and even have a LoadView
                            which shows the image is retrieved and being
                        </div>
