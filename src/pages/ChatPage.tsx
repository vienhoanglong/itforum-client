          ...
          <div className="px-0 border-solid md:w-1/3 border-[#dee2e6] border relative w-full overflow-hidden">
            <div className="bg-[#fafafa] p-[10px_15px] rounded-md flex justify-between items-center">
              <AvatarImage
                ...
                size={0}
                cln={
                  "w-[50px] h-[50px] rounded-[40px] border-none align-middle"
                }
              />
            ...
            <div>
              <div className="p-[10px_15px] flex align-middle transition-all duration-300 ease">
                ...
                <div className="ml-3 w-[70%] max-w-xs">
                  ...
                  <p className="m-0 text-text1 text-xs break-words truncate">
                    Cho Tran Hoang Long may dung la con cho ma hehehehehehehe
                    heheheheheheheheheehheheheheeheheheheheheheheeh
                  </p>
                </div>
          ...
          <div className="px-0 relative w-full md:w-2/3 border-solid border-[#dee2e6] border flex flex-col">
            ...
            <div className="pt-4 flex-grow">
              <div className="flex flex-wrap">
                <div className="mr-auto p-2 mx-8 md:p-2 bg-gray-200 rounded-lg animate-fadeIn">
                  Hello nè
                </div>
              </div>
              <div className="flex flex-wrap">
                <div className="ml-auto p-2 mx-8 md:p-2 bg-gray-200 rounded-lg animate-fadeIn">
                  Hello nè
                </div>
              </div>
            </div>
